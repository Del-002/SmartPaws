                        ...
                        <div class="col-lg-12">
                            <table class="table table-hover">
                                ...
                                <tbody class="text-center text-dark font-weight-bold">
                                    <?php
                                        $result = $pdo->query("SELECT * FROM owner_Profile ORDER BY Owner_Name ASC");
                                        while($row = $result->fetch()){
                                            ...
                                            echo '<tr>';
                                                ...
                                                echo '<td>
                                                    <form action="../SmartPaws/process/deleteClient.php" method="POST">
                                                        <input type="text" id="pass-id" name="c-id" value="'.$row['Owner_ID'].'" hidden></input>
