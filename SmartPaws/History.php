            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">E-consultation History</h1>
                    </div>

                    <div class="row mb-3">
                        <div class="col-lg-12 col-md-12 mb-3">
                            <table class="table table-hover text-center">
                                <thead class="text-center text-dark bg-info">
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                        $id = $_SESSION['Vet_ID'];
                                        $tbl = $pdo->query("SELECT * FROM econ_tbl AS E INNER JOIN pet_info_tbl AS P ON E.Pet_ID = P.Pet_ID INNER JOIN owner_profile AS O ON E.Owner_ID = O.Owner_ID WHERE E.Vet_ID = '$id' ORDER BY Date_Ans DESC ");
                                        while($row = $tbl->fetch()){
                                            include("modules/history-table.php");
                                        }
                                    ?>
                                </tbody>
                            </table>
