        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <img class="img-fluid img-thumbnail" src="img/sss.jpg">
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-12">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    //Get Info from Diagnosis Tbl
                                        $result = $pdo->query("SELECT * FROM pet_diagnosis_tbl WHERE Pet_ID = '$pet_ID'");
                                        while($row = $result->fetch()){
                                            echo '<tr> <th scope="row">';
                                            $dateDiag = date_create($row['Diagnosis_Date']);
                                            echo date_format($dateDiag,"m/d/Y");
                                            echo '</th><td>';
                                            echo $row['Weight'] . 'kg';
                                            echo '</td><td><p>';
                                            echo '-' . $row['Diagnosis'];
                            ...
                            <table class="table table-hover table-bordered">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th scope="col">Signature/VetName</th>
                                        <th scope="col">Follow Up</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    //Get info from Vaccine Tbl
                                        $result = $pdo->query("SELECT * FROM pet_vaccine_tbl WHERE Pet_ID = '$pet_ID'");
                                        while($row = $result->fetch()){
                                            ...
                                            echo '<td><p>' . $row['Vaccine_Type'] . '</p></td>';
                                            echo '<td>' . $row['Vet_Name'] . '</td>';
                                            echo '<td>' . date_format($followVax,"m/d/Y") . '</td> </tr>';
                                        }
                                    ?>
                                </tbody>
                            </table>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-12">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    //Get info from Deworm Tbl
                                        $result = $pdo->query("SELECT * FROM pet_deworm_tbl WHERE Pet_ID = '$pet_ID'");
                                        while($row = $result->fetch()){
                                            $dateDeworm = date_create($row['Deworm_Date']);
                                            $followDeworm = date_create($row['Follow_Date']);

                                            echo '<tr> <th scope="row">' . date_format($dateDeworm,"m/d/Y") . '</th>';
                                            echo '<td>' . $row['Weight'] . ' kg </td>';
                                            echo '<td><p>' . $row['Brand_Name'] . '</p></td>';
                                            echo '<td>' . $row['Vet_Name'] . '</td>';
                                            echo '<td>' . date_format($followDeworm,"m/d/Y") . '</td> </tr>';
                                        }
                                    ?>
                                </tbody>
                            </table>
