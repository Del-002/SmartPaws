    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="Vet_Dashboard.html">
                <div class="sidebar-brand-text mx-3 book">Alpha Pet Supplies</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link book" href="Vet_Dashboard.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                            <table class="table table-hover">
                                ...
                                <tbody class="text-center text-dark font-weight-bold">
                                    <?php
                                        $result = $pdo->query("SELECT * FROM appointment_tbl AS A INNER JOIN owner_profile AS O ON A.Owner_ID = O.Owner_ID INNER JOIN pet_info_tbl AS P ON P.Pet_ID = A.Pet_ID WHERE A.Status = 'Pending' ORDER BY Appointment_Date ASC, Appointment_Time ASC LIMIT 5");
                                        while($row = $result->fetch()){
                                            include("modules/appointments-table.php");
                                        }
                                    ?>
                                </tbody>
                            </table>
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-3 border-left-info">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <h4 class="h4 font-weight-bold text-info text-uppercase">
                                                Pending E-Consultation:<small class="h4 font-weight-bold text-gray-800">
                                                    <?php
                                                        /*$cnt = $pdo->query("SELECT COUNT(ID) AS PENDING FROM econ_tbl WHERE STATUS ='U'");
                                                        $ans = $cnt->fetch();
                    ...
                    <div class="row mb-3">
                        <?php
                            /*$catalog = $pdo->query("SELECT * FROM econ_tbl AS E JOIN owner_profile AS O ON E.Owner_ID = O.Owner_ID WHERE Status = 'U' ORDER BY Date_Consulted DESC LIMIT 2");
                            while($card = $catalog->fetch()){
                                include("modules/inquery-catalog.php");
                            }*/
                        ?>
                    </div>
                    <!---End--->
