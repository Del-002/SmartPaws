            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 Hi,">Hi, <?php echo $_SESSION['Name']?></span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 book">Pet Medical Records</h1>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                            <a href="R_New_Pet.php" style="text-decoration-line: none;" class="text-dark">
                            <div class="card mr-1 ml-1 shadow h-100 py-2 text-center">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-1">
                                        <!---Break--->
                                        ...
                                        <div class="col-lg-9 text-center align-self-center">
                                            <img class="card-img-top img-thumbnail border-0" src="img/Plus.png" alt="Card image cap">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-1">
                                        ...
                                        <div class="col-lg-9 text-center">
                                            <div class="card-text">
                                                <p class="h4"><strong>Add Record</strong></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php
                            $result = $pdo->query("SELECT * FROM pet_info_tbl AS P JOIN owner_profile AS O on P.Owner_ID = O.Owner_ID");
                            while($row = $result->fetch()){
                                include("modules/r-record-catalog.php");
                            }
                        ?>
                    </div>
