...
if(!empty($_POST['Pet_Name']) && !empty($_POST['Appointment_Date']) && !empty($_POST['Appointment_Time'])){
	...
	$query = "insert into appointment_tbl(Owner_ID, Pet_ID, Appointment_Date, Appointment_Time, Reason, Status) values ('$id','$Pet_Id' , '$Appointment_Date' , '$Appointment_Time','Deworming','Pending')";
