...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 book">Add Veterinarian Account</h1>
                    </div>
    ...
    <script>
        ...
        function formvalidation(){
            ...
            if(name != "" && surname != "" && username != "" && password != "" && contact != "" && email != ""){
        ...
        function createAcct(){
            ...
            var params = "name=" + fname + "&user=" + username + "&pass=" + password + "&con=" + contact + "&email=" + email;

            var xhttp = new XMLHttpRequest();

            xhttp.open("POST","../SmartPaws/process/addVetacct.php", true);
            xhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
