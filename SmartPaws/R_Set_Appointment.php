                                    ...
                                    <form>
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <label for="Owner ID">Owner Username</label>
                                                <input type="text" class="form-control" id="OwnerID" placeholder="Username"
                                                onchange="nameDisplay(this.value)">
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <select id="PetName" class="form-control" onchange="idDisplay(this.value)">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" type="button" data-dismiss="modal" onclick="setAppointment(this.value)">Yes</button>
                    <button class="btn btn-danger" type="button" data-dismiss="modal">No</a>
                </div>
            </div>
        </div>
    </div>
        ...
        function nameDisplay(str){
            if(str.length == 0){
                ...
                xhttp.onreadystatechange = function(){
                    if (this.readyState == 4 && this.status == 200){
                        document.getElementById("PetName").innerHTML = this.responseText;        
                    }
                };
                xhttp.send(params)
            }
